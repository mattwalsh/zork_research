...
?L4:	SET 'RETVAL,STR?8
	...
	.FUNCT V-ROOMS,F,N,TMP
	FIRST? ROOMS >F \FALSE
?L3:	NEXT? F >N /?L5
?L5:	PRINTI "<ROOM name='"
	PRINTD F
	PRINTI "' description='"
	GETP F,P?ACTION >STACK
	...
	PRINT TMP
	JUMP ?L13
?L10:	GETP F,P?ACTION >STACK
	CALL STACK,M-FLASH >STACK
?L13:	PRINTI "'>"
	CRLF
	CALL PRINT-FLAT-CONTENTS,F
	PRINTI "</ROOM>"
	CRLF
	SET 'F,N
	ZERO? F \?L3
...
?L37:	PRINTI "</ROOM>"
	...
	PRINTI "<ROOM_ITEMS>"
	CRLF
	CALL PRINT-FLAT-CONTENTS,HERE
	PRINTI "</ROOM_ITEMS>"
	CRLF
	PRINTI "<INVENTORY>"
	CRLF
	CALL PRINT-FLAT-CONTENTS,WINNER
	PRINTI "</INVENTORY>"
	CRLF
	PRINTI "<TROPHY>"
	CRLF
	CALL PRINT-FLAT-CONTENTS,TROPHY-CASE
	PRINTI "</TROPHY>"
	CRLF
	PRINTR "</RENDER>"
...
?L1:	CALL PERFORM,V?TAKE,PRSO
	...
	.FUNCT DESCRIBE-ROOM,LOOK?=0,SKIP$005fTITLE,V?,STR,AV
	SET 'V?,LOOK?
	ZERO? V? \?L1
	SET 'V?,VERBOSE
?L1:	ZERO? ONBIT \?L3
...
?L12:	CRLF
	CALL NULL-F
	RFALSE
?L8:	FSET? HERE,TOUCHBIT /?L18
	FSET HERE,TOUCHBIT
	SET 'V?,1
?L18:	FSET? HERE,MAZEBIT \?L21
	FCLEAR HERE,TOUCHBIT
?L21:	IN? HERE,ROOMS \?L24
	ZERO? SKIP$005fTITLE \?L24
	PRINTD HERE
	LOC WINNER >AV
	FSET? AV,VEHBIT \?L28
	PRINTI ", in the "
...
?L36:	LOC WINNER >AV
	...
	CRLF
	JUMP ?L42
?L39:	GETP HERE,P?ACTION >STACK
	CALL STACK,M-FLASH >STACK
?L42:	EQUAL? HERE,AV /TRUE
	FSET? AV,VEHBIT \TRUE
...
?L31:	CRLF
	...
	.FUNCT PRINT-FLAT-CONTENTS,OBJ,F,N
	FIRST? OBJ >F \FALSE
?L3:	NEXT? F >N /?L5
?L5:	FSET? F,INVISIBLE /?L6
	PRINTI "<ITEM name="""
	PRINTD F
	PRINTI """>"
	FIRST? F >STACK \?L10
...
?L58:	EQUAL? PRSA,V?THROW \FALSE
	...
	CALL OPEN-CLOSE,KITCHEN-WINDOW,STR?19,STR?18 >STACK
	RSTACK
...
?L1:	EQUAL? PRSA,V?CLOSE,V?OPEN \?L3
	...
	CALL OPEN-CLOSE,PRSO,STR?21,STR?20 >STACK
	RSTACK
...
?L23:	EQUAL? PRSA,V?CLOSE,V?OPEN \?L26
	...
	JUMP ?L31
?L29:	PUSH STR?29
?L31:	CALL OPEN-CLOSE,GRATE,STACK,STR?27
...
?L3:	INC 'WATER-LEVEL
	...
	CALL MUNG-ROOM,MAINTENANCE-ROOM,STR?33
...
?L61:	PRINTR "."
	...
	.FUNCT V-SCORE-RANK,RANK$005fNOW
	EQUAL? SCORE,350 \?L1
...
?L14:	RANDOM L >STACK
	...
	CALL STUPID-CONTAINER,BAG-OF-COINS,STR?57 >STACK
	RSTACK

	.FUNCT TRUNK-F
	CALL STUPID-CONTAINER,TRUNK,STR?58 >STACK
	RSTACK
